...
public class RegisterFormArea42 extends AppCompatActivity {

    // UI references.
    private AutoCompleteTextView mUsernameView;
    private EditText mPasswordView;
    private EditText mPasswordVerifView;
    private RegisterFormArea42 _page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordVerifView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                if (id == EditorInfo.IME_ACTION_DONE || id == EditorInfo.IME_NULL) {
                    attemptLogin();
    ...
    private void attemptLogin() {
        ...
        mPasswordVerifView.setError(null);
        ...
        String passwordVerif = mPasswordVerifView.getText().toString();
        ...
        // Check for a valid passwordVerif.
        if (TextUtils.isEmpty(passwordVerif)) {
            mPasswordVerifView.setError(getString(R.string.error_field_required));
            focusView = mPasswordVerifView;
            cancel = true;
        } else if (!isPasswordVerifValid(passwordVerif, password)) {
            mPasswordVerifView.setError(getString(R.string.error_invalid_password_verif));
            focusView = mPasswordVerifView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            Intent intent = new Intent(RegisterFormArea42.this, RequestRegisterLogin.class);
    ...
    private boolean isPasswordVerifValid(String passwordVerif, String password) {
        return passwordVerif.equals(password);
    }
